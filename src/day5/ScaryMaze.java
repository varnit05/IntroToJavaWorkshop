...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		if (mouseX > 75 && mouseX < 140 && mouseY > 852 && mouseY < 908) {
			speak("you have won, or have you?");
			showScaryImage("hqdefault.jpg");	
		}
	...
	@Override
	public void run() {
		JFrame frame = new JFrame("varnit's Scary Maze");
		frame.add(this);
